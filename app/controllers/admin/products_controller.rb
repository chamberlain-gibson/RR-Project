...
Products controller 
Creates product model data to the view to display to the user 
Save/updates user data to the model 
Has active_storage attached for the admin to adjust products from the Admin products page
=end
